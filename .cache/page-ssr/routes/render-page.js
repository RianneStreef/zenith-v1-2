...
exports.components = {
  ...
  "component---src-pages-services-jsx": () => __webpack_require__.e(/*! import() | component---src-pages-services-jsx */ "component---src-pages-services-jsx").then(__webpack_require__.bind(__webpack_require__, /*! ./../../../src/pages/services.jsx?export=default */ "./src/pages/services.jsx?export=default"))
};
...
exports.head = {
  ...
  "component---src-pages-services-jsx": () => __webpack_require__.e(/*! import() | component---src-pages-services-jsxhead */ "component---src-pages-services-jsxhead").then(__webpack_require__.bind(__webpack_require__, /*! ./../../../src/pages/services.jsx?export=head */ "./src/pages/services.jsx?export=head"))
};
...
try {
  ...
  if (e.toString().indexOf("Error: Cannot find module") !== -1) {
    throw new Error("Couldn't find layout component at \"" + "/Users/rianne/Desktop/Zenith/zenith-v1-2/src/components/Layout.jsx" + ".\n\n" + "Please create layout component in that location or specify path to layout component in gatsby-config.js");
  } else {
...
const StyledBurger = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].div`
  display: flex;
...
const Burger = props => {
  ...
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledBurger, {
    open: open,
...
const Header = props => {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    className: "hidden-desktop mobile-header"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "header-name"
  }, "Zenith Ski Shop"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Burger__WEBPACK_IMPORTED_MODULE_2__["default"], {
    language: language,
    setLanguage: setLanguage,
    languageToUse: languageToUse
  })));
...
/* harmony import */ var _images_online_rental_svg__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../images/online-rental.svg */ "./src/images/online-rental.svg");
...
const Layout = ({
  ...
  let {
    0: language,
    1: setLanguage
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("french");
  let languageToUse = "";
  const {
    0: pathname,
    1: setPathname
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    src: _images_online_rental_svg__WEBPACK_IMPORTED_MODULE_5__["default"],
    className: "button-location-en-ligne transparent",
    id: "location-en-ligne",
    alt: "online rental"
...
const Navbar = props => {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    src: _images_icon_en_png__WEBPACK_IMPORTED_MODULE_2__["default"],
    alt: "english",
    onClick: () => handleSetLanguage("english"),
    className: `flag ${languageToUse.language === "english" ? "opaque" : "fade"} `
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", {
    src: _images_icon_fr_png__WEBPACK_IMPORTED_MODULE_3__["default"],
    alt: "fran\xE7ais",
    onClick: () => handleSetLanguage("french"),
    className: `flag ${languageToUse.language === "french" ? "opaque" : "fade"} `
  })))));
...
const english = {
  language: "english",
  indexTitle: "Zenith Ski Shop - Val Thorens ski rental - Bootfitting specialist",
  metaDescription: "Val Thorens ski rental. Hire your skis / snowboard in Val Thorens -20% online. Zenith Ski Shop bootfitting specialist",
  metaKeywords: " Val Thorens ski rental, val thorens ski hire, val thorens snowboard rental, val thorens snowscoot, val thorens bootfitting, ski rental val thorens, ski boots val thorens",
  home: "Home",
  ...
  introText3: " (depending on your body, we customize your ski boots) for 30 years. ",
  introText3B: "The last independent ski shop in Val Thorens,",
  introText4: "  we focus on service and quality to moke your stay more enjoyable.",
  introText5: "Zenith Ski Shop also sells, rents and maintains your skis and snowboards.",
  introText6: "The entire team od Zenith Ski Shop wishes you great skiing and a pleasant stay in the best ski resort in France.",
  contactTitle: "ZENITH SKI SHOP IN VAL THORENS",
  contactIntro1: "Zenith Ski Shop is located in the centre of the Val Thorens resort, under the tourist office, Place Caron. Easy access by the road from one side and from the slopes on the other.",
  ...
  Usp1Text: "Bootfitting is our speciality! Feet are all different. It is normal to have to customize ski boots to get the best comfort while skiing.",
  Usp2Text: "The bionic knee brace dedicated to skiing had arrived. Forget joint pain and fatigue. Ski effortlessly with the exoskeleton.",
  Usp3Text: "Adaptation of your shoes, skis and snowboard maintenance, comfort solutions (heated soles and gloves, polarized lenses, etc.",
  ourServices: "Our services",
  explanationTitle: "ZENITH SKI SHOP - SKI AND SNOWBOARD RENTAL",
  explanationText1: "For your ski / snowboard / shoe rental ",
  explanationText2: "we offer equipment corresponding to your needs and level. ",
  explanationText3: "Our rental fleet is updated every year. Our rental shoes are dried and sanitized after each outing and, if necessary, we personalize the ones you rent. ",
  explanationText4: "You can change your skis during your stay and if your accommodation is for from the slopes, we can keep your skis overnight after a day of skiing. ",
  ...
  metaDescriptionBootfitting: "Bootfitting is our speciality! Feet are all different. It is normal to have to customize ski boots to get the best comfort while skiing.",
  ...
  bootfittingIntroLi2: " - specific soles to facilitate body alignment and foot stability ",
  bootfittingIntroLi3: "- high-performance, comfortable and breathable socks",
  bootfittingIntro4: "If you already have your equipment and you are suffering, we will be able to offer you a solution. It is not normal to endure pain in your feet while skiing, there is bound to be a solution.",
  bootfittingProblemTitle: "The main problems that we solve",
  bootfittingProblem1Title: "Cramps",
  bootfittingProblem1Text: "A pain on this part of the foot is often characterized by cramps, feet are the basis of the body and support your weight, the arch of the foot is stretched, cramps may occur. The adaptation of your boots will prevent this phenomenon.",
  bootfittingProblem2Title: "Cold",
  bootfittingProblem2Text: "When the temperature decreases and your boots are unsuitable or too tight, they cause bad circulation of the blood. Sensitivity to cold is also an important element. Our in-store solutions will correct this problem.",
  bootfittingProblem3Title: "Painful shins",
  bootfittingProblem3Text: "In every day life , your shins are never supporting you as much as when in ski boots. Because of this unusual position, your body and your sensitivity may be the cause of this pain.",
  bootfittingProblem4Title: "Blisters",
  bootfittingProblem4Text: "We have a solution against friction and moisture which causes blisters.",
  bootfittingProblem5Title: "Pain",
  bootfittingProblem5Text: "The pain may be varied and have various causes. We analyze your feet to determine the cause of your pain and treat it.",
  bootfittingProblem6Title: "Painful knees",
  bootfittingProblem6Text: "Misalignment of the feet, knees and hips can cause severe pain in the knees. We can correct this alignment.",
  bootfittingProblem7Title: "Hallux valgus",
  bootfittingProblem7Text: "Often called the onion, this foot deformity can be painful in a boots poorly adapted. We adapt boots to your morphology.",
  bootfittingProblem8Title: "Pain on the medial malleolus",
  bootfittingProblem8Text: "Your malleolus are subjected to pressure and friction, depending on your body (legs arched, x, flat or arched foot...) you can feel pain. The adaptation of boots will remove this pain.",
  ...
  metaDescriptionServices: "Adaptation of your shoes, skis and snowboard maintenance, comfort solutions (heated soles and gloves, polarized lenses, etc.",
  ...
  service1Text2: "For more information on boots and their possible customization visit our ",
  service1Link: "bootfitting page.",
  service2Title: "SKIS / SNOWBOARD MAINTENANCE SERVICE",
  service2Text1: "Our technicians take care of your skis or snowboard. They repair the damage, sharpen the edges and structure and wax the bases. For your safety and your pleasure, we offer you a free 'check up' of your skis and adjust your bindings according to the standards.",
  service2Text2: "We offer to keep your skis and snowboards that you have bought from us from one winter to the next, with quality maintenance so that you find your equipment prepared and ready to ride on your return.",
  service3Title: "COMFORT SERVICE",
  service3Text: "If you have cold feet or cold hands. If your vision is poor due to a scratched mask or not adapted to the conditions. If you are looking for solutions, we offer heated gloves, heated soles, polarized glass and fitted masks. We can guide you so you can ski in the best possible conditions",
  service4Title: "SKI / SNOWBOARD RENTAL",
  service4Text1: "We offer equipment corresponding to your needs and your level. Our rental fleet is updated each year. Skis and snowboards on sale are also part of our rental fleet. Your shoes are dried and disinfected after each outing and, if necessary, we customize those you rent for ever more comfort and pleasure on the slopes.",
  service4Text2: "You can change your equipment during your stay and if your not located close to the ski slopes, we can keep your equipment over night. For the rental of skis, snowboards or snowscoots, you can now rent your equipment online via our ",
  service4Link: "booking system.",
  mojoTitle: "Enjoy the pleasure of Augmented Skiing with the Ski~Mojo exoskeleton",
  metaDescriptionMojo: "The bionic knee brace dedicated to skiing had arrived. Forget joint pain and fatigue. Ski effortlessly with the exoskeleton.",
  mojoIcon1: "Pleasure",
  mojoIcon2: "Endurance",
  mojoIcon3: "Performance",
  mojoIcon4: "Safety",
  mojoExplanation1: "Reduces pain and drastically decreases pressure on the knees",
  mojoExplanation2: "Maximize your skiing time, or ski harder during winter holidays",
  mojoExplanation3: "Absorb the terrain like never before with super charged legs",
  mojoExplanation4: "Reduced muscular fatigue decreases the risk of injury",
  mojoP1: "Ski~Mojo is a mechanism based on a powerful adjustable spring that supports around 1/3 of the body weight. By compressing the springs in the bending phase, it restores energy and increases muscle power tenfold during extension.",
  mojoP2: "The suspension effect of the springs reduces vibrations, impacts and pressure on the knees by 40%. It also relieves the hips and back.",
  mojoP3: "Knee flexion requires an additional, imperceptible energy expenditure. This additional hamstring work, estimated at 10%, combined with a 30% reduction in quadriceps contraction helps to protect the cruciate ligaments.",
  mojoP4: "The production of lactic acid, which renders the muscles ineffective, is delayed and limited. This reduces the risk of fatigue-related accidents and muscle soreness.",
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "french": () => (/* binding */ french)
/* harmony export */ });
const french = {
  language: "french",
  indexTitle: "Zenith Ski Shop - Location ski Val Thorens - Spécialiste Bootfitting.",
  metaDescription: "Location ski Val Thorens. Reservez votre location de skis / snowboard à Val Thorens en ligne -20%. Zenith Ski Shop specialiste du bootfitting",
  ...
  bootfittingMetaTitle: "Bootfitting - Zenith Ski Shop",
  metaDescriptionBootfitting: "Le bootfitting c’est notre spécialité! Les pieds sont tous différents, il est normal de devoir aménager les chaussures pour un confort optimal en skiant.",
  ...
  bootfittingProblem2Title: "Froid",
  bootfittingProblem2Text: "Lorsque la température diminue et que vos chaussures sont mal adaptées ou trop serrées, elles empêchent la bonne circulation du sang. La sensibilité de chacun au froid est aussi un élément important. Nos solutions en magasin corrigeront ce problème.",
  bootfittingProblem3Title: "Tibia douloureux",
  bootfittingProblem3Text: "Dans la vie de tous les jours, vos tibias ne sont jamais soumis à des appuis comme ceux exercés dans les chaussures de ski. Le manque d’habitude, votre morphologie et votre sensibilité peuvent être la cause de cette douleur.",
  bootfittingProblem4Title: "Les ampoules",
  bootfittingProblem4Text: "Nous apportons une solution contre les frottements et/ou l'humidité qui sont à l'origine des ampoules.",
  bootfittingProblem5Title: "Douleurs",
  bootfittingProblem5Text: "Les douleurs peuvent être variées et les causes diverses. Nous analysons vos pieds pour déterminer la cause de vos douleurs et les traiter.",
  bootfittingProblem6Title: "Genou douloureux",
  bootfittingProblem6Text: "Le mauvais alignement des pieds, des genoux et des hanches peut entraîner de violentes douleurs aux genoux. Nous pouvons corriger cet alignement.",
  bootfittingProblem7Title: "Hallux valgus",
  bootfittingProblem7Text: "Souvent appelé l'oignon, cette déformation du pied peut être douloureuse dans une chaussure mal adaptée et entraînée d'autres douleurs. Nous adaptons les chaussures à votre morphologie.",
  bootfittingProblem8Title: "Douleur sur la malléole",
  bootfittingProblem8Text: "Vos malléoles sont soumises à des pressions et des frictions, suivant votre morphologie (jambes arquées, en X, pied plat ou voûté….) vous pouvez ressentir des douleurs. L'adaptation de chaussures supprimera cette douleur.",
  ...
  metaDescriptionServices: "Adaptations de vos chaussures, entretien skis et snowboards, solutions de confort (semelles et gants chauffants, verres polarisés,...)",
  ...
  service4Title: "LOCATION SKIS / SNOWBOARD",
  ...
  metaDescriptionMojo: "La genouillère bionique dédiée à la pratique du ski est arrivée. Oubliez vos douleurs articulaires et la fatigue. Skiez sans effort avec l'exosquelette.",
  mojoIcon1: "Plaisir",
  mojoIcon2: "Endurance",
  mojoIcon3: "Performance",
  mojoIcon4: "Sécurité",
...
/* harmony export */ });
/* harmony import */ var _content_english__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../content/english */ "./src/content/english.js");
/* harmony import */ var _content_french__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../content/french */ "./src/content/french.js");


const content = {
  english: _content_english__WEBPACK_IMPORTED_MODULE_0__.english,
  french: _content_french__WEBPACK_IMPORTED_MODULE_1__.french
};
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("data:image/svg+xml;base64,");

/***/ }),

/***/ "react-dom/server":
/*!********************************************************************************************!*\
  !*** external "/Users/rianne/Desktop/Zenith/zenith-v1-2/node_modules/react-dom/server.js" ***!
  \********************************************************************************************/
/***/ ((module) => {

"use strict";
module.exports = require("/Users/rianne/Desktop/Zenith/zenith-v1-2/node_modules/react-dom/server.js");

/***/ }),

/***/ "react":
/*!***************************************************************************************!*\
  !*** external "/Users/rianne/Desktop/Zenith/zenith-v1-2/node_modules/react/index.js" ***!
  \***************************************************************************************/
/***/ ((module) => {

"use strict";
module.exports = require("/Users/rianne/Desktop/Zenith/zenith-v1-2/node_modules/react/index.js");
