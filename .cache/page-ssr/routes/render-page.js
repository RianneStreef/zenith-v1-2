...
const Layout = ({
  ...
  let languageToUse = ""; //  let languageInStorage = "";
  // useEffect(() => {
...
const Navbar = props => {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    src: _images_icon_nl_png__WEBPACK_IMPORTED_MODULE_4__["default"],
    onClick: () => handleSetLanguage("dutch"),
    className: `flag ${languageToUse.language === "dutch" ? "opaque" : "fade"} `
  })))));
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "dutch": () => (/* binding */ dutch)
/* harmony export */ });
const dutch = {
  language: "dutch",
...
/* harmony import */ var _content_dutch__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../content/dutch */ "./src/content/dutch.js");
...
const content = {
  ...
  dutch: _content_dutch__WEBPACK_IMPORTED_MODULE_2__.dutch
};
